...
const Footer = () => {
  return (
    <div className="bg-stone-900 text-white grid md:grid-cols-4 grid-cols-1 md:gap-0 gap-10 items-center justify-around py-12 md:px-20 px-10">
      <h1 className="font-bold text-xl text-center md:-mt-20 mt-0">Kuku Sama</h1>
      ...
      <div className="flex flex-col gap-4 font-semibold items-center justify-center">
        <p className="cursor-pointer hover:underline text-yellow-500">Contact us</p>
        <p>Be the first to get our newsletter</p>
        <div className="md:mb-0 mb-10">
          <input className="bg-white/90 px-4 py-2 text-black placeholder-black placeholder-opacity-70 border-none focus:outline-none" type="email" placeholder="Enter your email address" />
